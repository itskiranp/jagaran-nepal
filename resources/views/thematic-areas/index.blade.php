...
@section('content')
    <div class="thematic-area-page">
        <!-- Hero Section -->
        <section class="thematic-hero text-white d-flex align-items-center justify-content-center">
            <div class="container text-center">
                <h1 class="display-4 fw-bold">Youth Empowerment</h1>
                <p class="lead text-warning">Empowering youth to become agents of change in their communities</p>
            </div>
        </section>
            ...
            <div class="container py-4">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <p >
                            JagaranNepal believes youths are active partners in the development process and transforming
                            them into active citizens enabling them in translating their ideas into action.
                        </p>
                        <p>
                            Youth Empowerment is one of the three thematic areas of JagaranNepal. It works to empower the
                            youth to become more aware of the issues in the country also aims to make them into active
                            citizens that work to improve their communities and the society as a whole. It focuses on
                            building youth leadership and participation.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="program-card card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="row g-0 h-100">
                                <div class="col-md-5">
                                    <img src="{{ asset('images/pic1.jpg') }}" class="img-fluid h-100 object-fit-cover"
                                        alt="Paramhba workshop">
                                </div>
                                <div class="col-md-7">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text">
                                            A three-day non-residential workshop targeted toward urban youths to build a
                                            common platform for youth innovation and engagement.
                                        </p>
                                        <ul class="program-features list-unstyled">
                                            <li class="mb-2"><i
                                                    class="bi bi-check-circle-fill text-primary me-2"></i>Activities,
                                                discussions, and games</li>
                                            <li class="mb-2"><i
                                                    class="bi bi-check-circle-fill text-primary me-2"></i>Local level
                                                interventions in Kathmandu</li>
                                            <li><i class="bi bi-check-circle-fill text-primary me-2"></i>Practical
                                                implementation of ideas</li>
                                        </ul>
                            ...
                            <div class="row g-0 h-100">
                                ...
                                <div class="col-md-7">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text">
                                            Meaning "identification", this three-day non-residential workshop empowers
                                            semi-rural youths to foster innovative ideas to address social issues.
                                        </p>
                                        <ul class="program-features list-unstyled">
                                            <li class="mb-2"><i class="bi bi-check-circle-fill text-primary me-2"></i>Soft
                                                skills development</li>
                                            <li class="mb-2"><i
                                                    class="bi bi-check-circle-fill text-primary me-2"></i>Design thinking
                                                approach</li>
                                            <li><i class="bi bi-check-circle-fill text-primary me-2"></i>Local
                                                resource-based interventions</li>
                                        </ul>
                                        <a href="#" class="btn btn-outline-primary mt-3">Learn More</a>
                                    </div>
                                </div>
